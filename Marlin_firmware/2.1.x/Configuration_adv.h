 ...
 */
   ...
   * below 2.
   */
  #define WATCH_TEMP_PERIOD  20               // Seconds //jpr
 ...
 */
//#define E0_AUTO_FAN_PIN -1 //jpr
#define E0_AUTO_FAN_PIN P2_04 //jpr
...
#define QUICK_HOME                          // If G28 contains XY do a diagonal move first //jpr
...
// @section bltouch
  ...
  #define BLTOUCH_FORCE_SW_MODE //jpr
   ...
   */
  #define BLTOUCH_SET_5V_MODE //jpr
 ...
 */
#define Z_STEPPER_AUTO_ALIGN //jpr
  ...
  //#define Z_STEPPER_ALIGN_XY { {  174, 215 }, { 174,  55 } } //jpr
  //#define Z_STEPPER_ALIGN_XY { {  150, 195 }, { 150,  55 } } //jpr
  //#define Z_STEPPER_ALIGN_XY { {  100, 150 }, { 150,  150 } } //jpr
   ...
   */
    ...
    #define Z_STEPPERS_ORIENTATION 1  //jpr
  #endif
  ...
  #define Z_STEPPER_ALIGN_ITERATIONS 8    // Number of iterations to apply during alignment //jpr
...
#define DISABLE_INACTIVE_Z false  // Set 'false' if the nozzle could fall onto your printed part! //jpr
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  #define STATUS_MESSAGE_SCROLLING //jpr
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define SCROLL_LONG_FILENAMES         // Scroll long filenames in the SD card menu //jpr
...
#define BABYSTEPPING //jpr
  ...
  #define DOUBLECLICK_FOR_Z_BABYSTEPPING  // Double-click on the Status Screen for Z Babystepping. //jpr
...
#define LIN_ADVANCE //jpr
  ...
  #define ALLOW_LOW_EJERK       // Allow a DEFAULT_EJERK value of <10. Recommended for direct drive hotends. //jpr
 ...
 */
#define ADVANCED_PAUSE_FEATURE //jpr
#if ENABLED(ADVANCED_PAUSE_FEATURE)
  #define PAUSE_PARK_RETRACT_FEEDRATE         40  // (mm/s) Initial retract feedrate. //jpr
  #define PAUSE_PARK_RETRACT_LENGTH            2  // (mm) Initial retract.
                                                  // This short retract is done immediately, before parking the nozzle.
  #define FILAMENT_CHANGE_UNLOAD_FEEDRATE     80  // (mm/s) Unload filament feedrate. This can be pretty fast. //jpr
  ...
  #define FILAMENT_CHANGE_SLOW_LOAD_LENGTH     5  // (mm) Slow length, to allow time to insert material. //jpr
                                                  // 0 to disable start loading and skip to fast load only
  #define FILAMENT_CHANGE_FAST_LOAD_FEEDRATE   6  // (mm/s) Load filament feedrate. This can be pretty fast.
  #define FILAMENT_CHANGE_FAST_LOAD_ACCEL     25  // (mm/s^2) Lower acceleration may allow a faster feedrate.
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH    100 // (mm) Load length of filament, from extruder gear to nozzle. //jpr
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
 ...
 */
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_24V        // All axes (override below) //jpr
   ...
   */
  #define MONITOR_DRIVER_STATUS //jpr
